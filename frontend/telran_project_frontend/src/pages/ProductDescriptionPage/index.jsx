              ...
              <div className={s.product_item_info}>
                ...
                <div className={s.product_item_payment}>
                  ...
                  <div className={s.product_item_payment_img}>
                    ...
                    <img
                      src={
                        process.env.PUBLIC_URL + "/images/mastercard-icon.png"
                      }
                      alt=""
                    />
                    <img
                      ...
                      src={
                        ...
                        "/images/american-express-icon.png"
                      }
                      alt=""
                    />
                    <img
