...
const initialState = [
  ...
  },
  {
    ...
    "price": 11.5,
    "discont_price": 11.1,
    "description": "In spring, our Director of Horticulture loves to plant the vigorous Australian Salvia `Wendy`s Wish` next to his back porch. Each morning as he sits outside enjoying his coffee, he watches the hummingbirds savor the sweet nectar from the tubular blossoms. Right up until frost, ‘Wendy’s Wish’ throws spike after spike of vivid magenta-pink blooms with fluted tips on maroon stems.",
  ...
  },
  {
    ...
    "price": 64,
    "discont_price": null,
    "description": "The 7\" regal red flowers of Amaryllis \"Lion King\" have an iridescent sparkle, a satiny throat, white eye zone, and deep dark, almost purple, veining. They crown 22-24\" stems that numbered three per bulb in our trials. Shipped in an 8\" wide x 7\" tall beige resin cachepot. The shapely blooms and rich, iridescent colors of Amaryllis light up a cold day like nothing else we know. We carefully prepare these tropical bulbs so they require only warm temperatures, attention to watering, and bright light to deliver a truly spectacular performance, a process that is great fun to watch.",
  ...
  },
  {
    ...
    "price": 88,
    "discont_price": null,
    "description": "The vibrant, salmon-peach blooms of Amaryllis \"Rilona\" reach up to 7\" in diameter and are sure to light up your home on a winter\\’s day. Flowers are borne on 24-30\" stems and gradually fade to a softer orange hue equally lovely for its subtlety. Superior cut flower. Two green nursery pots in a 15½\" long x 8¾\" wide x 7\" tall double basket. The shapely blooms and rich, iridescent colors of Amaryllis light up a cold day like nothing else we know. We carefully prepare these tropical bulbs so they require only warm temperatures, attention to watering, and bright light to deliver a truly spectacular performance, a process that is great fun to watch.",
  ...
  },
  {
    ...
    "price": 90,
    "discont_price": 87,
    "description": "Add interest to your autumn garden landscape with a cheerful trio of stone Acorns. This set of three decorative nuts is cast in a dense, durable product made to withstand the elements. The original design was hand sculpted in clay by artist Clifford Fredericks, giving the Acorns a distinctive artisan quality. ",
  ...
  },
  {
    ...
    "price": 24,
    "discont_price": null,
    "description": "The seed of the mighty Oak tree is reimagined in these intriguing seasonal accent pieces. The core of this decorative acorn is overlaid by hand with natural leaves in the rich tones of an autumn day. The topper is fashioned from real acorns. Display this quartet in a favorite bowl or basket, or use as a centerpiece for a favorite fall look. Teak bowl sold separately.",
  ...
  },
  {
    ...
    "price": 29,
    "discont_price": null,
    "description": "Our Blissful Harvest potpourri promises to engage your senses with the evocative fragrance of the season. Empty its contents into an attractive vessel and enjoy the aroma it releases inside your home; when the potpourri needs a refresh, use the included vial of fragrance to extend its life. Makes a perfect hostess or bread-and-butter gift. Handcrafted in California.",
  ...
  },
  {
    ...
    "price": 6.95,
    "discont_price": 6.7,
    "description": "Did you know your plant`s soil medium can make or break its overall growth and health? Woodie believes potting your plants in an all organic soil mixture that feeds your plant with nutrients, while still giving roots the space they need to breathe and grow. Try out Espoma`s Organic Potting Mix in your plantings this season and see your plants take off!",
  ...
  },
  {
    ...
    "price": 6.95,
    "discont_price": null,
    "description": "Orchids radiate a delicate beauty so powerful that it, at times, can be intimidating. With use of Espoma`s Organic Orchid Mix, you can give your beautiful plant the ideal environment for optimal growth.",
  ...
  },
  {
    ...
    "price": 13.95,
    "discont_price": 13.65,
    "description": "Espoma Organic Perlite makes the task of propagating plants quite easy and fun. This porous material is used to aid in aerating soil to allow air, water and nutrients to reach the roots of your plant.",
  ...
  },
  {
    ...
    "price": 14.95,
    "discont_price": null,
    "description": "Your potted plants deserve the best. Their roots can’t seek nutrition in the ground, so you have to bring it to them. That’s why Happy Frog® Potting Soil is amended with soil microbes that can help improve root efficiency and encourage nutrient uptake.26",
  ...
  },
  {
    ...
    "price": 13.95,
    "discont_price": null,
    "description": "The ocean harbors so many nutrients that not only are good for the soul, but good for our plants! Woodie loves this powerhouse blend of premium earthworm castings, bat guano, and sea-going fish and crab meal, and you will too!",
  ...
  },
  {
    ...
    "price": 12.95,
    "discont_price": null,
    "description": "In working to create the perfect soil medium for your potted plants, you may come across the use of charcoal in many planting experts` soil analyses. Hoffman`s Horticultural Charcoal is a extremely beneficial element to add to your soil mediums ensuring a plant is happy and healthy in its pot!",
  ...
  },
  {
    ...
    "price": 27.95,
    "discont_price": 27.05,
    "description": "A product that kills the bad insects but keeps the good one`s alive? Count me in! This all natural product is the ideal insect killer if your out to get those annoying pests that feed on your crops, without impacting your livestock or killing beneficial critters like earth worms!",
  ...
  },
  {
    ...
    "price": 12.99,
    "discont_price": null,
    "description": "Cement planter comes with a removable rubber plug for drainage",
  ...
  },
  {
    ...
    "price": 12.99,
    "discont_price": 12,
    "description": "Driving home for Christmas? This jolly cement planter is a great novelty planter for your favourite winter plants! Cement planter comes with a removable rubber plug for drainage",
  ...
  },
  {
    ...
    "price": 8.75,
    "discont_price": null,
    "description": "This Gold Linen Finish Plant Pot could be the star attraction to your Christmas table decor with its textured gold finish and star bow. Perfect for displaying your favourite Christmas blooms! Does not contain drainage holes",
  ...
  },
  {
    ...
    "price": 22.99,
    "discont_price": null,
    "description": "Whether you are looking for the perfect Christmas gift for your green-fingered loved one or the perfect pots to house your houseplants for your Christmas display, these Red & White Ceramic Christmas Pots are bound to bring cheer! Does not contain drainage holes. Comes as a set of 6",
  ...
  {
    "id": 34,
    "title": "Christmas Double Pine Cone Wreath White-TippedGrey Wreath with Half Pinus Nigra",
    "price": 19.99,
    "discont_price": null,
    "description": "The perfect complement to your Christmas décor during the festive season. Made of natural, recyclable materials. 40cm x 40cm.",
  ...
  },
  {
    ...
    "price": 4.99,
    "discont_price": 4.2,
    "description": "Festive and fancy, this Christmas wreath pick decoration is great for adding a touch of festive cheer to your Christmas plants and decor!\n",
  ...
  reducers: {
    ...
    filterByPriceRange(state, { payload }) {
      state.list.forEach(
        (item) =>
          (item.show =
            item.final_price >= payload[0] && item.final_price <= payload[1])
      );
    },
    resetFilters(state) {
      state.list = state.list.sort((a, b) => a.id - b.id).map((item) => ({ ...item, show: true, nameInSearchRange: true }));
    },
  },
